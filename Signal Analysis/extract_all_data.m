...
dataChannel = 47;   % A-1 starts at 1, A-2 starts at 33, 
                   % B-1 starts at 129
...
%completeFilePath = 'C:\Users\Tabitha\Desktop\Temp\170711_Set1.nev';
completeFilePath = 'C:\Users\Tabitha\Desktop\Temp\170710_Maze_Block1.ns2';
    ...
    case 'Spike'
        ...
        if plotStatus
            ...
            if isempty(uniqueUnits)
                for i = 1:size(spikeWindowData,2); plot(spikeWindowData(:,i),'b'); end
