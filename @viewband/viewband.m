...
if(dnum>0)
	...
	for didx = 1:dnum
        ...
        data.thetaTime(didx,:,:) = l.theta_time;
        data.thetaPowerSpec(didx,:,:) = l.tPowerSpec;
        data.alphaTime(didx,:,:) = l.alpha_time;
        data.alphaPowerSpec(didx,:,:) = l.aPowerSpec;
        data.gammaTime(didx,:,:) = l.gamma_time;
        data.gammaPowerSpec(didx,:,:) = l.gPowerSpec;
	end
