...
for i = 1:numArray
    ...
    fileNameTemp = ['session01',filesep,'array0',num2str(i),filesep,'stackedhp01-a',num2str(i),'.png'];
    print(fileNameTemp,'-dpng',resolutionValue);
    disp([fileNameTemp,' is saved...'])
    delete(pHp(i,1));
    
    set(pEHp(i,1), 'Visible', 'on');
    fileNameTemp = ['sessioneye',filesep,'array0',num2str(i),filesep,'stackedhpeye-a',num2str(i),'.png'];
    print(fileNameTemp,'-dpng',resolutionValue);
    disp([fileNameTemp,' is saved...'])
    delete(pEHp(i,1));
    
    set(pTHp(i,1), 'Visible', 'on');
    fileNameTemp = ['sessiontest',filesep,'array0',num2str(i),filesep,'stackedhptest-a',num2str(i),'.png'];
    print(fileNameTemp,'-dpng',resolutionValue);
    disp([fileNameTemp,' is saved...'])
    delete(pTHp(i,1));
end
...
for i = 1:numArray
    ...
    fileNameTemp = ['session01',filesep,'array0',num2str(i),filesep,'stackedlfp01-a',num2str(i),'.png'];
    print(fileNameTemp,'-dpng',resolutionValue);
    disp([fileNameTemp,' is saved...'])
    delete(pLfp(i,1));
    
    set(pELfp(i,1), 'Visible', 'on');
    fileNameTemp = ['sessioneye',filesep,'array0',num2str(i),filesep,'stackedlfpeye-a',num2str(i),'.png'];
    print(fileNameTemp,'-dpng',resolutionValue);
    disp([fileNameTemp,' is saved...'])
    delete(pELfp(i,1));
    
    set(pTLfp(i,1), 'Visible', 'on');
    fileNameTemp = ['sessiontest',filesep,'array0',num2str(i),filesep,'stackedlfptest-a',num2str(i),'.png'];
    print(fileNameTemp,'-dpng',resolutionValue);
    disp([fileNameTemp,' is saved...'])
    delete(pTLfp(i,1));
end
