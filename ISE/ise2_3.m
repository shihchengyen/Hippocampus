function [ise_out] = ise2_3(actual_image, shuffled_images, dim1, dim2)
    %Kian Wei's code
    ...
    %display how long it take to calculate ISE
    disp(['time taken to calculate for ise2_3: ' num2str(toc)]);
end
