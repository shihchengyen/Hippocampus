function [ise_out] = ise4_1(actual_image, shuffled_images, dim1, dim2)
    % Use one pixel neigher, without diagnal relationship
    ...
    for  i=1:size(combined,1)
        ...
        %   final calculation:
        ise_out = vert_entropy + hor_entropy + self_entropy;
