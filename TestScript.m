...
ProcessLevel(nptdata,'Levels','Days','Include',{'20181102'},'Exclude',{'sessioneye','session_merged'},'nptLevelCmd',{'Session','unitymaze(''auto'',''redo'');'});
vc = ProcessLevel(vmplacecell,'Levels','Days','Include',{'20181102'});
ProcessLevel(nptdata,'Levels','Days','Include',{'20181102'},'Exclude',{'sessioneye','session_merged'},'nptLevelCmd',{'Session','eyelink(''auto'',''redo'');'});
