...
if(~isa(p,classname))
    ...
    elseif(isempty(q))
        ...
        r.data.smoothingradii = padcat(p.data.smoothingradii, q.data.smoothingradii);
        ...
        r.data.smoothingradii1sthalf = padcat(p.data.smoothingradii1sthalf, q.data.smoothingradii1sthalf);
        ...
        r.data.smoothingradii2ndhalf = padcat(p.data.smoothingradii2ndhalf, q.data.smoothingradii2ndhalf);
